...
// If DISABLE_SERVER_LOGS is set, silence console to minimize logging/IO.
if (process.env.DISABLE_SERVER_LOGS) {
    const noop = (): void => {};
    // assign as any to satisfy TypeScript's stricter types in some environments
